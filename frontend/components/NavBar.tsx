        ...
        <div className="backdrop-blur-3xl bg-white/10 pr-2">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <img src="/logo.png" alt="Logo" className="hidden md:block h-[76px] w-[250px]" />
              <img src="/logo.png" alt="Logo" className="md:hidden h-[46px] w-[150px]" />
            </Link>

            {/* Desktop Navigation */}
            <div className="hidden md:flex items-center space-x-6">
              <Link href="/modules" className="text-border-black hover:text-gray-600 transition-colors">
                Modules
              </Link>
              <Link href="/stream-information-hub" className="text-border-black hover:text-gray-600 transition-colors">
                Streams
              </Link>
              ...
              <div className="flex items-center space-x-2">
                {user ? (
                  ...
                  <Button title="Sign In" otherClasses="text-white hover:text-gray-200" handleClick={() => router.push("/login")} />
                )}
              </div>
            </div>

            {/* Mobile Menu Button */}
            <button className="md:hidden text-white py-6" onClick={() => setIsOpen(!isOpen)}>
              <Menu size={24} />
            </button>
          </div>
        </div>
            ...
            >
              <div className="backdrop-blur-lg bg-white/10 rounded-2xl p-4 shadow-lg">
                <div className="flex flex-col space-y-4">
                  <Link href="/modules" className="text-border-black hover:text-gray-600 transition-colors px-4 py-2" onClick={() => setIsOpen(false)}>
                    Modules
                  </Link>
                  <Link href="/stream-information-hub" className="text-border-black hover:text-gray-400 transition-colors px-4 py-2" onClick={() => setIsOpen(false)}>
                    Streams
                  </Link>
