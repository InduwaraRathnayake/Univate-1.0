...
const HowItWorks = () => {
  return (
    <main className="flex flex-col md:flex-row items-center justify-center py-16 px-4  my-12 mx-auto ">
     
      <div className="flex-1 text-left px-12">
        <h1 className="text-6xl text-white font-bold my-4 mb-10">How it works</h1>
