  ...
  return (
    <main>
      ...
      <section className="bg-black text-white p-8 min-h-screen">
        <div className="text-center">
          <h1 className="text-4xl font-bold mt-5 mb-12">
            Career Opportunities in Main Stream
          </h1>
        </div>
      ...
      <section className="p-8 bg-white overflow-hidden">
        <h2 className="text-4xl font-bold text-black mb-10 text-center">Companies</h2>
        <div className="relative flex items-center mt-10 mb-10">
          <div className="flex gap-4 animate-scroll" style={{ animation: "scroll 20s linear infinite", whiteSpace: "nowrap" }}>
