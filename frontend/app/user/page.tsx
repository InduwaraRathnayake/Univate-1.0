...
const UserProfile = () => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900 bg-opacity-100 overflow-y-auto h-full w-full flex items-center justify-center" aria-modal="true" role="dialog">
        ...
        {activeTab === 'settings' && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className='mb-5 text-gray-600'>Manage your account settings and preferences here.</p>
